(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_1e229225._.js", {
...
function HipaaChecklistWrapper({ title, description, initialCategories, lastUpdated, onSave }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HipaaChecklistWrapper.useEffect": ()=>{
    ...
    const handleItemToggle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "HipaaChecklistWrapper.useCallback[handleItemToggle]": (itemId, completed)=>{
            setCategories({
                "HipaaChecklistWrapper.useCallback[handleItemToggle]": (prevCategories)=>{
                    const updatedCategories = prevCategories.map({
                        "HipaaChecklistWrapper.useCallback[handleItemToggle].updatedCategories": (category)=>{
                            const updatedItems = category.items.map({
                                "HipaaChecklistWrapper.useCallback[handleItemToggle].updatedCategories.updatedItems": (item)=>{
                                    if (item.id === itemId) {
                                        return {
                                            ...item,
                            ...
                            }["HipaaChecklistWrapper.useCallback[handleItemToggle].updatedCategories.updatedItems"]);
                            return {
                                ...category,
                                items: updatedItems
                            };
                        }
                    }["HipaaChecklistWrapper.useCallback[handleItemToggle].updatedCategories"]);
                    if (onSave) {
                        onSave(updatedCategories);
                    }
                    return updatedCategories;
                }
            }["HipaaChecklistWrapper.useCallback[handleItemToggle]"]);
        }
    }["HipaaChecklistWrapper.useCallback[handleItemToggle]"], [
        onSave
    ]);
...
_s(HipaaChecklistWrapper, "fwusbYofJiqZFbCKheDOYRlEHP0=");
...
"[project]/src/lib/mock-data/hipaa-checklist-data.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function HipaaChecklistsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HipaaChecklistsPage.useEffectKey": ()=>{
            setResetKey({
                "HipaaChecklistsPage.useEffectKey": (prev)=>prev + 1
            }["HipaaChecklistsPage.useEffectKey"]);
        }
    }["HipaaChecklistsPage.useEffectKey"], [
        selectedCategory
...
_s(HipaaChecklistsPage, "W0AahThtlreJE+fWIshkwj1+4Xk=", false, function() {
    return [
...
//# sourceMappingURL=src_1e229225._.js.map