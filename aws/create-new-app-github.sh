...
# This script handles the entire process of setting up a new service using GitHub
...
CPU="1 vCPU"
MEMORY="2 GB"
GITHUB_REPO="your-github-username/company-wiki"  # You'll need to mirror to GitHub
BRANCH="main"
...
# 3. Set up connection to GitHub
echo "Step 3: Setting up connection to GitHub..."
...
if [ -z "$CONNECTION_ARN" ]; then
  echo "Creating new connection to GitHub..."
  ...
  echo "Follow the GitHub authorization flow."
  echo "Then press Enter to continue..."
  read -p "Press Enter after completing the connection setup..."
else
  echo "Using existing GitHub connection: $CONNECTION_NAME"
fi
